...
export const Achievements: React.FC<AchievementsProps> = ({ achievements }) => {
  return (
    <section className="max-w-7xl mx-auto px-6 mb-[68px] md:mb-[84px]">
      <div className="p-8 md:p-12 bg-indigo-900 rounded-[3rem] text-white shadow-2xl shadow-indigo-200">
        <div className="flex items-center gap-3 mb-8">
          <Award className="w-8 h-8 text-amber-400" />
          <h3 className="text-3xl sm:text-4xl font-black tracking-tighter">KEY ACHIEVEMENTS.</h3>
        </div>
