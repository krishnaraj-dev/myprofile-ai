...
export const Leadership: React.FC<LeadershipProps> = ({ leadership }) => {
  const getIcon = (index: number) => {
    switch (index) {
      case 0: return <Users className="w-6 h-6 text-indigo-600" />;
      case 1: return <Cpu className="w-6 h-6 text-emerald-600" />;
      case 2: return <TrendingUp className="w-6 h-6 text-amber-600" />;
      case 3: return <GitMerge className="w-6 h-6 text-rose-600" />;
      default: return <Shield className="w-6 h-6 text-indigo-600" />;
    }
  };

  const getGradient = (index: number) => {
    switch (index) {
      case 0: return "from-indigo-50 to-blue-50/50 border-indigo-100/50";
      case 1: return "from-emerald-50 to-teal-50/50 border-emerald-100/50";
      case 2: return "from-amber-50 to-orange-50/50 border-amber-100/50";
      case 3: return "from-rose-50 to-pink-50/50 border-rose-100/50";
      default: return "from-slate-50 to-slate-50/50 border-slate-100/50";
    }
  };

  return (
    <section id="leadership" className="max-w-7xl mx-auto px-6 mb-[68px] md:mb-[84px] scroll-mt-32 md:scroll-mt-40">
          ...
          <div className="lg:w-1/3 flex flex-col justify-center">
            ...
            >
              ...
              <p className="text-lg text-slate-600 font-medium leading-relaxed">
                Driving excellence through mentorship, architectural oversight, and strategic technical planning to build high-performing engineering cultures.
              </p>
            </motion.div>
          </div>
